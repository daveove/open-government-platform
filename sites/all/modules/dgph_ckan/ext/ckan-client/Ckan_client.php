...
class Ckan_client
{
	...
	private $resources = array(
		...
		'create_user' => 'action/user_create',
		'update_user' => 'action/user_update'
	);
	...
	private function set_base_url()
	{
		...
		$this->base_url = "http://$host/catalogue/api/";
	}
	...
	public function create_user($params)
	{
		...
		return $this->make_request('POST', $this->resources['create_user'], $jparams);
	}
	...
	{
		$jparams = json_encode($params);
		return $this->make_request('POST', $this->resources['update_user'], $jparams);
	}
