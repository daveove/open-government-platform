...
<?php foreach ($tables as $table_id => $table): ?>
  ...
  <div class="forum-wrap">
    <div class="forum-superheader">
      ...
      <?php endif; ?>
      <div class="forum-description"><?php print $table_info->description; ?></div>

    </div>
    <div id="forum-<?php print $table_info->tid; ?>">
      <div class="forum forum-forums"><!-- table -->
        <div class="forum-headers">
          <div class="row">
            <div class="large-6 columns"><?php print t('Forum'); ?></div>
            <div class="large-2 columns"><?php print t('Topics'); ?></div>
            <div class="large-2 columns"><?php print t('Posts'); ?></div>
            <div class="large-2 columns last-post"><?php print t('Last post'); ?></div>
          </div>
        </div>

          <?php foreach ($table['items'] as $item_id => $item): ?>
            <?php if ($item->is_container): ?>
              <div id="subcontainer-<?php print $item_id; ?>" class="row <?php print $item->zebra; ?> container-<?php print $item_id; ?>-child"><!-- tr -->
              <?php else: ?>
              <div id="forum-<?php print $item_id; ?>" class="row <?php print $item->zebra; ?> container-<?php print $item_id; ?>-child"><!-- tr -->
              <?php endif; ?>

              <?php $colspan = ($item->is_container) ? 'large-8' : 'large-4' ?>
              <div class="large-6 columns forum-details">

			    <div class="forum-img-icon">
				...
				<div class="forum-container">
					...
					<?php if (!empty($item->description)): ?>
					  <div class="forum-description">
						<?php print text_summary($item->description, $format = NULL, 150); ?>
					  </div>
					<?php endif; ?>

					<div class="forum-view-link">
					  <a href="<?php print $item->link; ?>"><?php print t("VIEW"); ?></a>
					</div>
              ...
              <?php if (!$item->is_container): ?>
                <div class="large-2 columns text-center forum-number-topics">
                ...
                <div class="large-2 columns text-center forum-number-posts">
                ...
                <div class="large-2 columns forum-last-reply">
